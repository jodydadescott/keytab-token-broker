...
1. Create an example configuration with the command `C:\Program Files\KTBServer/ktbserver.exe config example > ktbserver.conf`
1. Edit the configuration and place it somewhere on the local disk or in a Git Repo
1. Use the command `C:\Program Files\KTBServer/ktbserver.exe config set LOCATION`
